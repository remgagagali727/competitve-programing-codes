...
void sol() {
// void sol(int t) {
    // MONTH * 40 days easiest conversion
    // 280 dias

    vector<pair<string, pair<int, int>>> m = {
        {"aquarius", {21, 59}},
        {"pisces", {60, 2 * 40 + 20}},
        {"aries", {2 * 40 + 21, 3 * 40 + 20}},
        {"taurus", {3 * 40 + 21, 4 * 40 + 21}},
        {"gemini", {4 * 40 + 22, 5 * 40 + 21}},
        {"cancer", {5 * 40 + 22, 6 * 40 + 22}},
        {"leo", {6 * 40 + 23, 7 * 40 + 21}},
        {"virgo", {7 * 40 + 22, 8 * 40 + 23}},
        {"libra", {8 * 40 + 24, 9 * 40 + 23}},
    };
}
