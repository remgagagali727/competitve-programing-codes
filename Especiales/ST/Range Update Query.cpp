...
struct STreeLazy{
    ...
    STLNode unir(STLNode n1, STLNode n2) {
        STLNode toReturn;

        return toReturn;
    }

    STLNode inicializar(ll v) {
        STLNode toReturn;
    ...
    STLNode qry(int l, int r) {
        return qry(0, n - 1, l, r, 0);
    }

    STLNode qry(int lt, int rt, int l, int r, int nodo) {
